...
if(rs4.next())
{
    String username=rs4.getString("dealer");
...
<div class="col-sm-5 col-xs-6 tital " >Address:</div><div class="col-sm-7"><%=rs.getString("address")%><div>
  ...
  String sql4="SELECT  count(* )FROM  connection where dname=?";
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 item text">
                            <h3>FarmDestiny</h3>
                            <h4>FarmDestinyis a diversified, full-time family farm
                              ...
                              of sustainable agriculture, and we work to be as selfsufficient as possible.</h4>
                        </div>
